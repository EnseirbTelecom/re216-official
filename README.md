...
Voici la grille de notation à titre indicatif seulement. **Pour pouvoir prétendre à etre noté sur un jalon donné, toutes les fonctionnalités et spécificités des jalons précédents doivent être implémentées sans erreurs**
